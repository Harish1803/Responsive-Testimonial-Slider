const reviews = [
    {
        author: 'CodeWithHarish',
        job: 'Programmer',
        text: 'Harish is also known as CodeWithHarish on youtube. He has a hude subscribers youtube channel. He had done his study in B.Tech Computer Science.',
        img: 'https://www.codewithharry.com/img/logo-blue.png'
    },
    {
        author: 'Thirlo',
        job: 'YouTuber',
        text: 'Thirlo is also known as Thirlo on youtube. She has a huge subscribers youtube channel. She is pursuing B.A. from MDU Rohtak and Part Time Youtuber',
    ...
    },
    {
        author: 'Thirlo',
        job: 'YouTube Creator',
        text: 'She is most popular YouTube Creator with 599K subscribers and 22M+ video views. She makes freelancing, career and tech related content for students. And he have also the chance to talk with entrepreneurs like Ankur Warikoo and Noah Kagan on his channel.',
